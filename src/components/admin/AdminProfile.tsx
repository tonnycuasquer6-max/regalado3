...
const Modal: React.FC<{ isOpen: boolean; onClose: () => void; children: React.ReactNode }> = ({ isOpen, onClose, children }) => {
    ...
    return createPortal(
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[9999999] flex items-center justify-center p-4 font-mono">
...
const AdminProfile: React.FC<{ session: Session; onCancel: () => void }> = ({ session, onCancel }) => {
    ...
    // MATEMÁTICAS SEPARADAS POR CLIENTE (AQUÍ ESTÁ EL PRIMER FIX DE TYPE: ANY)
    ...
    // AQUÍ ESTÁ EL SEGUNDO FIX DE TYPE: ANY
